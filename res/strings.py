...
Каб атрымаць карту наведаных табою месцаў юзай каманду /visits_map_districts для раёнаў і /visits_map_regions для абласцей.
"""
...
def visited_districts(visited, total):
    return f'Я наведаў {visited}/{total} раёнаў!'


def visited_regions(visited, total):
    return f'Я наведаў {visited}/{total} абласцей!'


def you_selected(place_name):
    return f'Вы выбралі {place_name}. Усё правільна?'
